...
// Fetches and displays suggested credit cards
const SecondPage = () => {
  ...
  // Fetch credit card suggestions when the component mounts
  useEffect(() => {
    const fetchCards = async () => {
      ...
      try {
        const response = await fetch(
          "http://127.0.0.1:8000/suggestions/api/top_cards?salaried=true",
          {
            method: "GET",
...
//Combines FirstPage and SecondPage
